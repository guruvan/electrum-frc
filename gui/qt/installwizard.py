...
MSG_ENTER_ANYTHING    = _("Please enter a wallet seed, a master public key, a list of Freicoin addresses, or a list of private keys")
...
class InstallWizard(QDialog):
    ...
    def __init__(self, config, network, storage):
        ...
        self.setWindowTitle('Electrum-FRC' + '  -  ' + os.path.basename(self.storage.path))
    ...
    def restore_or_create(self):
        vbox = QVBoxLayout()
        main_label = QLabel(_("Electrum-FRC could not find an existing wallet."))
    ...
    def waiting_dialog(self, task, msg= _("Electrum-FRC is generating your addresses, please wait.")):
        def target():
            task()
    ...
    def network_dialog(self):
        ...
        label = QLabel(_("Electrum-FRC communicates with remote servers to get information about your transactions and addresses. The servers all fulfil the same purpose only differing in hardware. In most cases you simply want to let Electrum-FRC pick one at random if you have a preference though feel free to select a server manually.") + "\n\n" \
