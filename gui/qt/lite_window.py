...
try:
    ...
    print "You need to have PyQT installed to run Electrum-FRC in graphical mode."
...
class MiniWindow(QDialog):
    ...
    def __init__(self, actuator, expand_callback, config):
        ...
        self.setWindowTitle("Electrum-FRC")
    ...
    def set_balances(self, btc_balance):
        ...
        self.setWindowTitle("Electrum-FRC %s - %s %s" % (electrum_version, amount, unit))
...
class ReceivePopup(QDialog):
    ...
    def setup(self, address):
        ...
        self.setWindowTitle("Electrum-FRC - " + _("Receive Freicoin payment"))
