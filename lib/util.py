...
def user_dir():
    if "HOME" in os.environ:
        return os.path.join(os.environ["HOME"], ".electrum-frc")
    elif "APPDATA" in os.environ:
        return os.path.join(os.environ["APPDATA"], "Electrum-frc")
    elif "LOCALAPPDATA" in os.environ:
        return os.path.join(os.environ["LOCALAPPDATA"], "Electrum-frc")
    elif 'ANDROID_DATA' in os.environ:
        return "/sdcard/electrum-frc/"
    else:
...
def appdata_dir():
    """Find the path to the application data directory; add an electrum-frc folder and return path."""
    if platform.system() == "Windows":
        return os.path.join(os.environ["APPDATA"], "Electrum-frc")
    elif platform.system() == "Linux":
        return os.path.join(usr_share_dir(), "electrum-frc")
    elif (platform.system() == "Darwin" or
          platform.system() == "DragonFly" or
          platform.system() == "OpenBSD" or
          platform.system() == "FreeBSD" or
	  platform.system() == "NetBSD"):
        return "/Library/Application Support/Electrum-frc"
    else:
